    ...
    return {
        "providers": {
            "test_ollama": {
                ...
                "status": "active",
                "models": [{"name": "test-model:7b", "size": "7B", "specialty": "general"}],
            },
            "test_vllm": {
                "type": "vllm",
                "base_url": "http://localhost:8001",
                "status": "active",
                "models": [{"name": "test-vllm-model", "size": "13B", "specialty": "chat"}],
            },
            "test_disabled": {
                "type": "ollama",
...
def mock_mappings():
    ...
    return {
        ...
        "fallback_chains": {
            "test-model:7b": {"chain": ["test-vllm-model"], "strategy": "immediate"}
        },
        "load_balancing": {
            "test-redundant": {
                "providers": [
