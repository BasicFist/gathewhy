...
class ThroughputProfiler:
        ...
        with ThreadPoolExecutor(max_workers=concurrency) as executor:
            ...
            for future in as_completed(futures):
                ...
                if completed % print_interval == 0 or completed == total_requests:
                    ...
                    print(f"   Progress: {completed:4d}/{total_requests} "
    ...
    def print_sweep_summary(self, results: List[ThroughputResult]) -> None:
        ...
        best_concurrency = results.index(best_result) + 1

        print(f"\n🎯 Optimal concurrency: ~{[1, 2, 5, 10, 20, 50][results.index(best_result)]} "
